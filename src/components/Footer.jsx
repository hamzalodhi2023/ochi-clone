...
function Footer() {
  return (
    <div className="flex w-full h-screen bg-zinc-700 p-20 gap-10">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading ">
          <h1 className="text-[8vw] uppercase font-semibold leading-none -mb-13">
            EYe-
          </h1>
          <h1 className="text-[8vw] uppercase font-semibold leading-none -mb-13">
            Opening
      ...
      <div className="w-1/2 ">
        <h1 className="text-[6vw] uppercase font-semibold leading-none -mb-13">
          Presentation
        </h1>
        <div className="dets mt-10">
          {[
            ...
            <a
              href="#"
              key={index}
              className="block px-10 my-2 text-2xl font-light"
            >
              {item}
            </a>
          ))}
